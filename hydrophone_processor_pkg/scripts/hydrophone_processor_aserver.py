...
class HydrophoneProcessorAServer(Node):
    ...
    def isolate_sample(self):
        ...
        for i in self.new_dataframe: #range(0,len(self.new_dataframe)): #if this doesnt work try 614000 for testing
    ...
    def peak_detect(self, channels):
        ...
        """
        peak_detect_one = peakdetect.peakdetect(channels[0],x_axis=None, lookahead=1,delta=40000) #TODO
